...
while ((select (count(*)) Total from TableCreator) > @Counter)
begin
...
set @TableCreatorString = ('echo         IsActive char (3) Not Null Default ''Yes''  >> "E:\DotNetCoreProjects\RxForEyeIPD\RxForEyeIPD\Components\Pages\DynamicFileCreator\' + @TableName +'\SqlScript\'+ @TableName +'.sql"')
EXEC xp_cmdshell @TableCreatorString
